...
export default class UsuarioVueltasController {
    private static _instance: UsuarioVueltasController;
            ...
            if(err) {
                ...
                MySQL.sendQuery(query, [body.atleta], (err:any, data:Object[][]) => {
                    ...
                    if(err) {
                        ...
                        SocketServer.getInstance().sendVuelta(body.atleta, data);
                    }
                });
                res.json({
                    ok: true,
